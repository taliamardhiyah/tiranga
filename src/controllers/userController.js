...
const aviator = async (req, res) => {
    let auth = req.cookies.auth;
    res.redirect(`https://pasificrim.live/theninja/src/api/userapi.php?action=loginandregisterbyauth&token=${auth}`);
    res.redirect(`https://pasificrim.live/#/jet/loginbyauth/${auth}`);
}
    ...
    if (data) {
        if (data == 1) {
            ...
            if (check >= data && point_list.total1 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received Rp ${point_list.total1}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total1 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge Rp 300 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 2) {
            ...
            if (check >= get && point_list.total2 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received Rp ${point_list.total2}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total2 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge Rp 3000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 3) {
            ...
            if (check >= get && point_list.total3 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received Rp ${point_list.total3}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total3 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge Rp 6000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 4) {
            ...
            if (check >= get && point_list.total4 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received Rp ${point_list.total4}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total4 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge Rp 12000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 5) {
            ...
            if (check >= get && point_list.total5 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received Rp ${point_list.total5}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total5 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge Rp 28000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 6) {
            ...
            if (check >= get && point_list.total6 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received Rp ${point_list.total6}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
            } else if (check < get && point_list.total6 != 0) {
                return res.status(200).json({
                    message: 'Please Recharge Rp 100000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
        ...
        if (data == 7) {
            ...
            if (check >= get && point_list.total7 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received Rp ${point_list.total7}.00`,
                    status: true,
                    timeStamp: timeNow,
                });
                ...
                return res.status(200).json({
                    message: 'Please Recharge Rp200000 to claim gift.',
                    status: false,
                    timeStamp: timeNow,
                });
...
const recharge = async (req, res) => {
    ...
    if (recharge.length == 0) {
        ...
        const apiData = {
            ...
            redirect_url: `https://pasificrim.live/wallet/verify/upi`,
            udf1: 'TIRANGA',
        };
...
const withdrawal3 = async (req, res) => {
    ...
    const minimumMoneyWd = process.env.MINIMUM_MONEY_WD || 50000; // Default minimum jika env tidak diset
    ...
    // Tambahan pengecekan minimum withdrawal
    if (money < minimumMoneyWd) {
        return res.status(200).json({
            message: `Minimum withdrawal is Rp${Number(minimumMoneyWd).toLocaleString('id-ID')}`,
            status: false,
            timeStamp: timeNow,
        });
    }
            ...
            if (userInfo.money - money >= 0) {
                if (result == 0) {
                    if (total - total2 >= 0) {
                        if (result == 0) {
                            return res.status(200).json({
                                message: 'Total taruhan tidak cukup untuk memenuhi permintaan',
                                status: false,
                                timeStamp: timeNow,
                            });
                        }
