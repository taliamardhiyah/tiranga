...
const sendTelegramMessage = async (message) => {
  const telegramToken = '8044580404:AAER7Wx0BKPmDtskjZA5dDD2oZHLzh0MXnE'; // Ganti dengan token bot Anda
  const chatId = '-1002156817349'; // Ganti dengan ID chat atau grup Anda
